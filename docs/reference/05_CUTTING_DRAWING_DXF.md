...
المستخدم يحتاج Capabilities مختلفة للعرض/إعادة الحساب/الرفع/الاعتماد. اعتماد الخطة هو نقطة تثبيت لما سيغادر مرحلة التخطيط إلى الإنتاج. تبويب **الخطة المعتمدة** يعكس علاقة `Door Cutting Order.approved_plan` الحالية فقط؛ فتح التاب لا يعتمد خطة، ولا تُعرض خطة Approved يتيمة أو تابعة لطلب آخر كاعتماد لهذا الطلب.
