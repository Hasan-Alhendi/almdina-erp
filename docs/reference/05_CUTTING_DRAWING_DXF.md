...
- طباعة الألواح تعرض مسارات Extra الهندسية (لاينر / فرزة ظهر / مسكة غطس) بألوانها، ورموزًا مستقلة لدبل القشاط ودبل كامل الدرفة، ودليل الرموز أعلى شبكة الألواح في كل صفحة طباعة.
