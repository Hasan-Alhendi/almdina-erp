...
- طباعة الألواح تعرض مسارات Extra في مواضعها: فرزة ظهر بخط متقطع أخضر أنحف، ولاينر بخط متقطع واحد أزرق، ومسكة غطس كمستطيل بخطوط رفيعة، مع رموز مستقلة لدبل القشاط ودبل كامل الدرفة ودليل الرموز أعلى شبكة الألواح في كل صفحة طباعة.
