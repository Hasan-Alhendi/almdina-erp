...
| Developer | [02 — Architecture](02_ARCHITECTURE.md) | [07 — Change Rules](07_CHANGE_RULES.md) + [13 — Frontend Architecture](13_FRONTEND_ARCHITECTURE.md) + [14 — Refactor Closure](14_FRONTEND_REFACTOR_CLOSURE.md) + [15 — Lifecycle Closure](15_FRONTEND_LIFECYCLE_CLOSURE.md) عند تعديل الواجهة |
| Coding AI | `AGENTS.md` | [02](02_ARCHITECTURE.md) + [07](07_CHANGE_RULES.md) + [13](13_FRONTEND_ARCHITECTURE.md) + [14](14_FRONTEND_REFACTOR_CLOSURE.md) + [15](15_FRONTEND_LIFECYCLE_CLOSURE.md) لأي Frontend change |
...
- [15 — Frontend Lifecycle Closure](15_FRONTEND_LIFECYCLE_CLOSURE.md)
