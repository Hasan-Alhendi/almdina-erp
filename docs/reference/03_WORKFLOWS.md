...
إذا كان مفتاح **إرسال واتساب عند الإتمام** مفعّلًا على مرحلة المسار، تُرسل بعد نجاح Handoff رسالة نصية للزبون من قالب قسم رسائل واتساب لتلك المرحلة. فشل الإرسال لا يُلغي إتمام المرحلة.
