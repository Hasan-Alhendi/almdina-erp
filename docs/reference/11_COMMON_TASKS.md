...
## 3. رسم درفة خاصة — مدخل البيانات/عامل الرسم

**الهدف:** نقل شكل الزبون بطريقة واضحة وقابلة للتحقق.

1. افتح الطلب الصحيح وتأكد من رقم DCO قبل الرسم.
2. افتح Drawing workspace من سياق الطلب المسموح.
3. ارسم الشكل/الأبعاد المطلوبة بأدوات المحرر.
4. احفظ الرسم المرتبط بالقطعة/الطلب المقصود.
5. إذا كانت الخطة ستعتمد على DXF خارجي، ارفع الملف فقط ضمن مرحلة/صلاحية الرسم المسموحة.
6. راجع أن الرسم/الملف مرتبط بالطلب الحالي وليس طلبًا سبق فتحه.

**مهم:** الرسم السهل للمستخدم لا يلغي Server-side geometry validation.
