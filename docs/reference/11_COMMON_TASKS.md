...
6. احفظ الطلب. زر الحفظ يجب أن يتحول إلى «تعديل» من أول نقرة إذا نجح التثبيت. إذا كانت التغييرات تؤثر على توزيع القطع وكنت تملك `recalculate_plan`، يبدأ حساب خطة النظام والتكلفة في الخلفية دون تجميد الشاشة.
