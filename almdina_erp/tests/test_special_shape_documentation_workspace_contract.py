...
class TestSpecialShapeDocumentationWorkspaceContract(unittest.TestCase):
    ...
    def test_page_loads_only_new_layered_subsystem(self) -> None:
        ...
        self.assertIn("bindActivationLifecycle", page)
        self.assertIn("onDeactivate: () => deactivate(wrapper)", page)
        self.assertIn("owner.generation() !== generation", page)
        self.assertNotIn("hide.aldDocumentation", page)
