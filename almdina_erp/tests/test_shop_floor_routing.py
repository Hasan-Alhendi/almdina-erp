...
class TestShopFloorRouting(unittest.TestCase):
	...
	def test_stage_role_and_department_maps(self):
		self.assertEqual(sfs.STAGE_ROLE["Sharyoun"], "عامل شريون")
		self.assertEqual(sfs.STAGE_ROLE["Drawing"], "عامل رسم")
		self.assertEqual(sfs.STAGE_ROLE["CNC"], "عامل CNC")
		self.assertEqual(sfs.STAGE_ROLE["Sanding"], "عامل تقشيط")
