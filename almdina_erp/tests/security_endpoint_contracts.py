...
_GROUPS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    ("almdina_erp.almdina_erp.services.dxf_export_service", C, ("download_uploaded_dxf", "get_validated_dxf_plan", "normalize_dxf_for_autocad",)),
    ...
    ("almdina_erp.almdina_erp.services.order_kanban_service", C, ("add_card", "update_order", "update_order_for_single_card")),
    ("almdina_erp.almdina_erp.services.order_lifecycle_service", C, ("cancel_order", "resume_cancelled_order", "return_order_to_draft")),
    ...
    (
        "almdina_erp.almdina_erp.services.whatsapp_service",
        C,
        (
    ...
    ("almdina_erp.almdina_erp.services.shop_floor_query_service", C, ("get_assignee_filter_options", "get_current_stage_context", "get_dispatch_options", "get_my_archive", "get_my_inbox", "get_order_operational_role_flags", "get_ready_for_delivery", "get_revert_targets", "get_shop_floor_context", "get_status_filter_options")),
