...
_GROUPS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    ("almdina_erp.almdina_erp.services.shop_floor_query_service", C, ("get_current_stage_context", "get_dispatch_options", "get_my_archive", "get_my_inbox", "get_order_operational_role_flags", "get_ready_for_delivery", "get_status_filter_options", "get_revert_targets", "get_shop_floor_context")),
