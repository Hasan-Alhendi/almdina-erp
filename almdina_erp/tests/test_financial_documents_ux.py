...
def test_customer_invoice_delegates_layout_and_internal_report_stays_distinct() -> None:
    ...
    assert 'function measurementDocumentBody(frm, customerPhone = "")' in customer_print
    assert 'function measurementDocumentBodyWithPayload(frm, payload, customerPhone = "")' in customer_print
