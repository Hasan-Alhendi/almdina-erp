...
TOOLBAR_STABILITY_JS = APP_ROOT / "public" / "js" / "door_cutting_order_toolbar_stability_ux.js"
...
def test_measurement_table_fits_the_form_without_horizontal_scrolling():
    ...
    assert ".dco-fast-table.dco-col-edges{width:188px!important;}" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    assert ".dco-fast-table.dco-col-edges{width:188px!important;}" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    ...
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not in compact_source
    assert ".dco-fast-table.dco-col-edges" not