(() => {
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            @media(max-width:600px){.almdina-sf-tabs{border-radius:10px}.almdina-sf-tab{flex:1 1 calc(33% - 8px);padding:8px 6px}.almdina-sf-actions .btn{flex:1 1 calc(50% - 8px)}}
        `;
