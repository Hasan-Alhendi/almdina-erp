(() => {
    ...
    function installStyles() {
        ...
        style.textContent = `
            ...
            .${ROOT_CLASS} [data-almdina-workspace-status="loading"] .dco-cost-empty {
                ...
                border:1px dashed var(--border-color,#d9e0e6);
                border-radius:var(--dco-workspace-radius-sm);
                background:linear-gradient(180deg,var(--subtle-fg,#f8fafc),var(--card-bg,#fff));
                font-weight:750;
            }
            ...
            .${ROOT_CLASS} [data-almdina-workspace-status="loading"] .dco-cost-empty::after {
                ...
                animation:dco-a53-workspace-shimmer 1.25s ease-in-out infinite;
                pointer-events:none;
            }

            @keyframes dco-a53-workspace-shimmer {
            ...
            .${ROOT_CLASS} [data-fieldname="order_cost_invoice_html"][data-almdina-workspace-editing="1"]::before {
                ...
                border-radius:var(--dco-workspace-radius-sm);
                background:rgba(36,144,239,.075);
            ...
            .${ROOT_CLASS} [data-almdina-workspace-editing="1"] .almdina-workspace-field-editor {
                padding:4px;
                border-radius:12px;
                background:rgba(36,144,239,.055);
            }
            ...
            .${ROOT_CLASS} .dco-cost-actions .btn:focus-visible {
                ...
                box-shadow:var(--dco-workspace-ring) !important;
            }
            ...
            .${ROOT_CLASS} [data-fieldname="plan_control_actions"] .dco-plan-actions-shell {
                border-radius:var(--dco-workspace-radius) !important;
                border-color:var(--border-color,#dce3e8) !important;
            ...
            .${ROOT_CLASS} .dco-cost-section-title h4 {
                font-size:14.5px !important;
                letter-spacing:.005em;
            }

            .${ROOT_CLASS} .dco-cost-table-wrap {
            ...
            .${ROOT_CLASS} .dco-cost-table th {
                ...
                top:0;
                z-index:2;
                background:var(--subtle-fg,#f7f9fb) !important;
                box-shadow:0 1px 0 var(--border-color,#e7ebef);
            }

            .${ROOT_CLASS} .dco-cost-table tbody tr {
                transition:background-color .12s ease;
            }

            .${ROOT_CLASS} .dco-cost-table tbody tr:hover td {
                background:rgba(36,144,239,.035);
            }
            ...
            .${ROOT_CLASS} .dco-invoice-total-card {
                border-radius:0 0 var(--dco-workspace-radius) var(--dco-workspace-radius) !important;
                padding:20px 22px !important;
            }

            .${ROOT_CLASS} .dco-invoice-total-card b {
            ...
            .${ROOT_CLASS} .page-actions .dco-context-edit-cancel {
                border-radius:9px;
                font-weight:800;
            }
            ...
            @media (max-width:900px) {
                ...
                .${ROOT_CLASS} [data-fieldname="plan_control_actions"] .dco-plan-actions {
            ...
            @media (max-width:560px) {
                ...
                .${ROOT_CLASS} .dco-cost-table {
                    min-width:680px;
                }
                .${ROOT_CLASS} .dco-cost-table th,
                .${ROOT_CLASS} .dco-cost-table td {
                    padding:8px 9px;
                }
                .${ROOT_CLASS} .dco-invoice-total-card {
    ...
    function refresh(frm) {
        ...
        if (root && root.classList) root.classList.add(ROOT_CLASS);
