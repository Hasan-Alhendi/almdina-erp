...
- `list_view/`: Door Cutting Order list presentation, combined search, current-department filter shortcut (display label, query by linked `stage_type`), status/stage presentation and list quick actions.
