...
class Capability:
    ...
    # Historical persisted key; business meaning is approval of the selected
    # production cutting plan, whether generated by the system or imported DXF.
    APPROVE_DXF = "approve_dxf"
    SET_OFFCUT_EXECUTION_OWNER = "set_offcut_execution_owner"
...
_CAPABILITY_DEFINITIONS = (
    ...
    CapabilityDefinition(Capability.SET_OFFCUT_EXECUTION_OWNER, Capability.SET_OFFCUT_EXECUTION_OWNER, CUTTING_PLAN_DOCTYPE, "cutting_plan"),
