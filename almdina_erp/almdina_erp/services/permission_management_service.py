...
def get_permission_console(role: str | None = None) -> dict[str, Any]:
    """Return the manual permission console payload for existing roles."""
...
def export_role_permissions(role: str) -> dict[str, Any]:
    """Export one role matrix as a versioned, checksummed backup document."""
...
def preview_permission_import(
    ...
    """Validate and preview a one-role backup; saving remains explicit."""
