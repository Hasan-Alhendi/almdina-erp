...
def build_navigation_context(
    ...
    *,
    ...
    # Landing-page ownership deliberately stays with Frappe. Role Home Page and
    # user Default Workspace are native Frappe concerns; this context only
    # describes authorization-driven navigation visibility.
    return {
        "shared_shell": active,
