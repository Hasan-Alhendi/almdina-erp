...
CAPABILITY_PRESENTATION: dict[str, dict[str, str]] = {
    ...
    Capability.VIEW_FACTORY_SETTINGS: _presentation("عرض إعدادات المعمل", "عرض إعدادات القص والتكلفة وضوابط الإنتاج وهوية أوراق الطباعة ورسائل واتساب دون تعديل أو ربط جلسة."),
